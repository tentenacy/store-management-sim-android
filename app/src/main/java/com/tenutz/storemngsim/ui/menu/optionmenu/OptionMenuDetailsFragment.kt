        ...
        binding.btnOptionMenuDetailsSave.setOnClickListener {
            Validator.validate(
                onValidation = {
                    ...
                    Validator.validateDiscountingPrice(binding.editOptionMenuDetailsDiscountedAmount.text.toString())
                    Validator.validateAdditionalPackagingPrice(binding.editOptionMenuDetailsPackagingAmount.text.toString())
                    Validator.validateShowDate(binding.editOptionMenuDetailsShowSdate.text.toString(), binding.editOptionMenuDetailsShowEdate.text.toString())
                    Validator.validateNumberData(binding.editOptionMenuDetailsShowShour.text.toString())
                    Validator.validateNumberData(binding.editOptionMenuDetailsShowSmin.text.toString())
                    Validator.validateEventDate(binding.editOptionMenuDetailsEventSdate.text.toString(), binding.editOptionMenuDetailsEventEdate.text.toString())
                    Validator.validateNumberData(binding.editOptionMenuDetailsEventShour.text.toString())
                    Validator.validateNumberData(binding.editOptionMenuDetailsEventSmin.text.toString())
                },
                onSuccess = {
                    lifecycleScope.launch {
                        vm.updateOptionMenu(
                            ...
                            OptionUpdateRequest(
                                ...
                                showDateFrom = binding.editOptionMenuDetailsShowSdate.text.toString()
                                    .replace("-", ""),
                                showDateTo = binding.editOptionMenuDetailsShowEdate.text.toString()
                                    .replace("-", ""),
                                ...
                                showDayOfWeek = listOfNotNull(
                                    binding.textOptionMenuDetailsShowWeekdayMon.text.toString()
                                        .takeIf { binding.textOptionMenuDetailsShowWeekdayMon.isChecked },
                                    binding.textOptionMenuDetailsShowWeekdayTue.text.toString()
                                        .takeIf { binding.textOptionMenuDetailsShowWeekdayTue.isChecked },
                                    binding.textOptionMenuDetailsShowWeekdayWed.text.toString()
                                        .takeIf { binding.textOptionMenuDetailsShowWeekdayWed.isChecked },
                                    binding.textOptionMenuDetailsShowWeekdayThu.text.toString()
                                        .takeIf { binding.textOptionMenuDetailsShowWeekdayThu.isChecked },
                                    binding.textOptionMenuDetailsShowWeekdayFri.text.toString()
                                        .takeIf { binding.textOptionMenuDetailsShowWeekdayFri.isChecked },
                                    binding.textOptionMenuDetailsShowWeekdaySat.text.toString()
                                        .takeIf { binding.textOptionMenuDetailsShowWeekdaySat.isChecked },
                                    binding.textOptionMenuDetailsShowWeekdaySun.text.toString()
                                        .takeIf { binding.textOptionMenuDetailsShowWeekdaySun.isChecked },
                                ).joinToString(","),
                                eventDateFrom = binding.editOptionMenuDetailsEventSdate.text.toString()
                                    .replace("-", ""),
                                eventDateTo = binding.editOptionMenuDetailsEventEdate.text.toString()
                                    .replace("-", ""),
                                ...
                                eventDayOfWeek = listOfNotNull(
                                    binding.textOptionMenuDetailsEventWeekdayMon.text.toString()
                                        .takeIf { binding.textOptionMenuDetailsEventWeekdayMon.isChecked },
                                    binding.textOptionMenuDetailsEventWeekdayTue.text.toString()
                                        .takeIf { binding.textOptionMenuDetailsEventWeekdayTue.isChecked },
                                    binding.textOptionMenuDetailsEventWeekdayWed.text.toString()
                                        .takeIf { binding.textOptionMenuDetailsEventWeekdayWed.isChecked },
                                    binding.textOptionMenuDetailsEventWeekdayThu.text.toString()
                                        .takeIf { binding.textOptionMenuDetailsEventWeekdayThu.isChecked },
                                    binding.textOptionMenuDetailsEventWeekdayFri.text.toString()
                                        .takeIf { binding.textOptionMenuDetailsEventWeekdayFri.isChecked },
                                    binding.textOptionMenuDetailsEventWeekdaySat.text.toString()
                                        .takeIf { binding.textOptionMenuDetailsEventWeekdaySat.isChecked },
                                    binding.textOptionMenuDetailsEventWeekdaySun.text.toString()
                                        .takeIf { binding.textOptionMenuDetailsEventWeekdaySun.isChecked },
                                ).joinToString(","),
                            )
                        ) {
                            pVm.optionMenus()
